(() => {
  ...
  var INTRO_KEY = "dar-rashed-intro-seen";
  var introOverlay = document.getElementById("intro-overlay");
  var introLogo = document.getElementById("intro-logo");
  var header = document.querySelector("header");
  var headerLogo = document.getElementById("header-logo");
  var navItems = gsapWithCSS.utils.toArray(".nav-item");
  var heroImages = document.querySelectorAll("#default-carousel img");
  var heroTitle = document.querySelector(".max-w-2xl h1");
  var heroDivider = document.querySelector(".max-w-2xl .w-20");
  var heroSubtitle = document.querySelector(".max-w-2xl p");
  var heroCtas = document.querySelector(".ctaButton");
  ...
  function runMasterTimeline() {
    ...
    const master = gsapWithCSS.timeline();
    if (!hasSeenIntro && introOverlay && introLogo && headerLogo) {
      gsapWithCSS.set(introOverlay, {
        autoAlpha: 1,
        display: "flex",
        pointerEvents: "auto"
      });
      ...
      if (header) {
        gsapWithCSS.set(header, { autoAlpha: 1, y: 0 });
      }
    }
    master.add("hero");
  ...
  function setupScrollAnimations() {
    gsapWithCSS.utils.toArray(".about-text").forEach((block) => {
    ...
    gsapWithCSS.utils.toArray(".activity-card").forEach((card) => {
    ...
    gsapWithCSS.utils.toArray(".news-card").forEach((card, index) => {
      gsapWithCSS.from(card, {
        scrollTrigger: {
          trigger: card,
          start: "top 85%",
    ...
    gsapWithCSS.utils.toArray(".book-card").forEach((card, index) => {
      gsapWithCSS.from(card, {
        scrollTrigger: {
          trigger: card,
          start: "top 85%",
